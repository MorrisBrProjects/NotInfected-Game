...
import de.morrisbr.notinfected.game.FPSControll;
...
public class GameScreenThreeDScreen implements Screen {
    ...
    public GameScreenThreeDScreen(NotInfected notInfected) {
    ...
    public void render(float delta) {
        ...
        if(Gdx.input.isKeyJustPressed(Input.Keys.ESCAPE)) {
            notInfected.setScreen(new TitleScreen(notInfected));
        }
    }
